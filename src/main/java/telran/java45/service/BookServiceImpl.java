...
public class BookServiceImpl implements BookService {
	...
	public Boolean addBook(BookDto bookDto) {
		...
		Publisher publisher = publicherRepository.findById(bookDto.getPublisher())
				.orElseGet(() -> publicherRepository.save(new Publisher(bookDto.getPublisher())));
...
//		Publisher publisher = publicherRepository.findById(publisherName).orElseThrow(EntityNotFoundException::new);
...
//		return publicherRepository.findDistinctByBooksAuthorsName(authorName).map(p->p.getPublisherName()).collect(Collectors.toList());
	...
	public AuthorDto removeAuthor(String authorName) {
		Author author = authorRepository.findById(authorName).orElseThrow(EntityNotFoundException::new);
		Stream<Book> bookStream = bookRepository.findBooksByAuthorsName(authorName);
